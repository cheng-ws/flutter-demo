        ...
        child: Column(
          ...
          // widget customization
              ...
              textFieldBuilder: (controller, focusNode) {
                return MyTextField(controller, focusNode,_selectedItem);
              },
              onItemSelected: (item){
                setState(() {
                  _selectedItem = item;
...
class MyTextField extends StatelessWidget {
  const MyTextField(this.controller, this.focusNode,this._selectedItem);
    ...
    return Padding(
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          ...
          hintText:  "${_selectedItem !=null ?_selectedItem.username:""
            "搜索书籍......"}",
